...
public class SimulationConfiguration {
  ...
  public static final boolean ETH = false;
  public static final boolean USING_RELAY_NETWORK = false;
  /**
   * if using elastico, how many committees there would be
   */
  public static final int NUM_OF_COMMITTEES = 0;

  /**
   * The number of nodes that is in the Directory.
   */
  public static final int NUM_OF_DIRECTORY_NODES = NUM_OF_COMMITTEES;

  /**
   * The number of normal nodes.
   */
  public static final int NUM_OF_NORMAL_NODES = 60; // 6000; //

  /**
   * The number of nodes participating in the blockchain network.
   */
  //TODO revert (?)
  public static final int NUM_OF_NODES = NUM_OF_NORMAL_NODES + NUM_OF_DIRECTORY_NODES;//600;//800;//6000;
  // public static final int NUM_OF_NODES = 600;//600;//800;//6000;

  /**
   * The constant number used for size of observcedBlocks.
   */
  public static final int OBSERVED_BLOCKS_SIZE = 10;

  /**
   * whether use elastico protocol or not
   */
  public static final boolean SHARDED = false;

  /**
   * The kind of routing table.
   */
  //public static final String TABLE = "simblock.node.routing.ShardedRoutingTable";
   ...
   */
  public static final long INTERVAL = 1000 * 60 * 10;//1000*60;//1000*30*5;//1000*60*10; //15000; //
   ...
   */
  public static final long BLOCK_SIZE = 535000;//0.5MB // 40045; //535000;//20045; //6110;//8000;//
  ...
  /**
   * The rate of nodes being a miner.
   */
  public static final float MINER_NODE_RATE = 1;

  /**
   * The rate of nodes that utilize the relay network.
   * DON'T CHANGE!!
   */
  public static final float RELAY_NETWORK_RATE = 0; //0.2f; //

  /**
   * Any factor that the researcher want to incorporate into the simulator.
   * makeRandomList will be used that following such rate.
   * Currently, this parameter represents the nodes that follows block propagation pipeline protocol
   */
  public static float RESEARCH_PARAM = 0; // 0.02f; //0.4f; // 0.1f; //

  public static float BLOXROUTE = 0; //1; //0.01f; //
  public static final int ENCRYPTION_TIME = 50; // 50; //

  public static int BANDWIDTH_IMPROVEMENT = 2;
  /**
