...
public class NetworkConfiguration {
   ...
   */
  public static final List<String> REGION_LIST_1 = new ArrayList<>(
      Arrays.asList("NORTH_AMERICA", "EUROPE", "SOUTH_AMERICA", "ASIA_PACIFIC", "JAPAN",
                    "AUSTRALIA"
      ));

  public static final List<String> REGION_LIST_2 = new ArrayList<>(
          Arrays.asList("Tokyo", "Ireland")
  );

  public static final List<String> REGION_LIST = REGION_LIST_1;
  ...
  private static final long[] DOWNLOAD_BANDWIDTH_2 = {
          39900000, 51000000
  };
  ...
  private static final long[] UPLOAD_BANDWIDTH_2 = {
          39900000, 51000000
  };
  ...
  private static final double[] REGION_DISTRIBUTION_2 = {
          0.5, 0.5
  };
  /**
  ...
  private static final double[] DEGREE_DISTRIBUTION_2 = {
          1.0, 1.0
  };
  /**
