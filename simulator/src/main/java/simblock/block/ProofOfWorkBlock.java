...
public class ProofOfWorkBlock extends Block {
  ...
  public ProofOfWorkBlock(ProofOfWorkBlock parent, Node minter, long time, int numberOfTx, List<Transaction> transactions, BigInteger difficulty) {
    ...
    if (parent == null) {
      ...
      // and total_mining_power does not change once generated by genminingpower() function in Main.java
  ...
  public static ProofOfWorkBlock genesisBlock(Node minter) {
    ...
    return new ProofOfWorkBlock(null, minter, 0, 0, null, BigInteger.ZERO);
  }
}
